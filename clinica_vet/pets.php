...
<body>
    ...
    <h1>Meus Pets </h1>
    <a href='cadpet.php'>Cadastrar pet </a> 
    </section>
    <?php
    ...
    $result_pet = "SELECT * FROM pet WHERE id_usuario = '$id'  LIMIT $inicio, $qnt_result_pag";
    ...
    <?php
    $result_pag = "SELECT COUNT(id) as num_result FROM pet WHERE id_usuario = $id";
    ...
    $max_links = 2;
    echo "<a href='pets.php?pagina=1'>Primeira</a>";
    
    for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
        if($pag_ant >= 1){
            echo "<a href='pets.php?pagina=$pag_ant'>$pag_ant</a>";
        }
    }
    ...
    for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
        if($pag_dep <= $quant_pag){
            echo "<a class='pag' href='pets.php?pagina=$pag_dep'>$pag_dep</a>";
        }
    }

    echo "<a href='pets.php?pagina=$quant_pag'>Ultima</a>"
